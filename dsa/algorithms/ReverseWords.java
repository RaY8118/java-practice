...
public class ReverseWords {
   ...
   * Space Complexity: O(n), for the StringBuilder used to store the reversed string.
   */
   ...
   *
   * Time Complexity: O(L), where L is the total number of characters in the sentence.
   *   This includes splitting the sentence and reversing each word.
   * Space Complexity: O(L), for storing the array of words and the result StringBuilder.
   */
  public static String reverseWords(String sentence) {
    ...
    // Note: trimToSize() only reduces the capacity, not the content. Use trim() for content.
